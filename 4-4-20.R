...
save.image("quantValueSPY.RData")
...
#tickers[!(tickers %in% FIN$Ticker)]
#tickers[!(tickers %in% VAL$Ticker)]
tickers <- tickers[(tickers %in% FIN$Ticker)]
# *******************************************************************************************
#                                 Backtest Function
# *******************************************************************************************
# ALGO: 
...
REBAL = REBAL[REBAL > as.Date("2021-01-01")]
